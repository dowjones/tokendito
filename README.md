...
## What's new
With the release of Tokendito 2.0, we are introducing many changes and fixes. It is a breaking release: your configuration needs to be updated, the command-line arguments hve changed, and support for python < 3.7 is has been removed. Consult the [release notes](releases/latest) page for a list of changes, and [additional notes](docs/README.md) for details.  
